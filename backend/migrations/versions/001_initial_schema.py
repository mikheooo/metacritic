...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "embedding", sa.JSON().with_variant(postgresql.JSONB(), "postgresql"), nullable=True
        ),
        sa.Column(
    ...
    op.create_index(
        op.f("ix_game_platforms_platform_id"), "game_platforms", ["platform_id"], unique=False
    )
    ...
    op.create_index(
        op.f("ix_similar_games_similar_game_id"), "similar_games", ["similar_game_id"], unique=False
    )
    ...
    op.create_index(
        op.f("ix_daily_crawl_states_processing_date"),
        "daily_crawl_states",
        ["processing_date"],
        unique=True,
    )
    ...
    op.create_index(
        op.f("ix_daily_game_processings_id"), "daily_game_processings", ["id"], unique=False
    )
    op.create_index(
        op.f("ix_daily_game_processings_processing_date"),
        "daily_game_processings",
        ["processing_date"],
        unique=False,
    )
    op.create_index(
        op.f("ix_daily_game_processings_game_external_id"),
        "daily_game_processings",
        ["game_external_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_daily_game_processings_crawl_run_id"),
        "daily_game_processings",
        ["crawl_run_id"],
        unique=False,
    )
